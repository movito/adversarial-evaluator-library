...
**Task**: .kit/tasks/2-todo/AEL-0006-add-model-requirement-to-evaluators.md
...
- **Interface Contract**: `docs/adr/ADR-0005-library-workflow-interface-contract.md`
- **Task Spec**: `.kit/tasks/2-todo/AEL-0006-add-model-requirement-to-evaluators.md`
...
**Task File**: `.kit/tasks/2-todo/AEL-0006-add-model-requirement-to-evaluators.md`
