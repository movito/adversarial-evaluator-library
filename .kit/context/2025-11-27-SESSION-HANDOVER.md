...
- Created `./.kit/launchers/preflight` script to validate requirements before onboarding
- Fixed `set -e` bug in preflight (arithmetic operations return 1 when value is 0)
- Updated `./.kit/launchers/onboarding` to run preflight before launching agent
