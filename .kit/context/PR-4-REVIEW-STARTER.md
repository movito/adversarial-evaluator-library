...
### New Files
- `docs/adr/ADR-0006-anthropic-cross-provider-usage.md` - Decision record for cross-provider changes
...
- `docs/adr/ADR-0005-library-workflow-interface-contract.md` - Clarified resolution priority (ADV-0032)
...
3. Provide this file path: `.kit/context/PR-4-REVIEW-STARTER.md`
