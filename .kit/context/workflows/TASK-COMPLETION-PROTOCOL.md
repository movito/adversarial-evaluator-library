...
7. ✅ **Handoff document created** (`.kit/context/HANDOFF-TO-*.md`)
...
### Filename:
```
.kit/context/HANDOFF-TO-<AGENT>-TASK-YYYY-####.md
```
...
- `.kit/context/SCRIPTWRITER-MVP-IMPLEMENTATION-COMPLETE.md`
- `.kit/context/HANDOFF-TO-FEATURE-DEVELOPER-TASK-2025-0037.md`
- `.kit/context/TASK-P3-001-IMPLEMENTATION-COMPLETE.md`
...
- **Handoff Examples**: `.kit/context/*.md`
