...
**Task**: `.kit/tasks/2-todo/AEL-0005-phase1-evaluator-implementation.md`
...
- ADR-0002: `docs/adr/ADR-0002-evaluator-expansion-strategy.md`
- Testing Guide: `docs/EVALUATOR-TESTING-GUIDE.md`
- Test Fixtures: `tests/fixtures/code_samples/`
- Task File: `.kit/tasks/2-todo/AEL-0005-phase1-evaluator-implementation.md`
