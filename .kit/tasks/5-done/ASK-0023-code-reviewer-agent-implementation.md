...
2. Create review report template in `.kit/context/templates/`
3. Create reviews directory `.kit/context/reviews/`
...
- [ ] Reviews saved to `.kit/context/reviews/ASK-XXXX-review.md`

### Should Have

- [ ] Review template in `.kit/context/templates/review-template.md`
...
- Create `.kit/context/reviews/` directory
- Create `.kit/context/templates/review-template.md`
