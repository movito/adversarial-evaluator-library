...
reconfigure)
    ...
    if [[ ! -f ".serena/project.yml" ]]; then
        ...
        echo "Run '.kit/launchers/onboarding' first to configure your project"
        exit 1
    fi
...
|-----------|---------------|-----------|
| `.serena/project.yml` missing | "Error: .serena/project.yml not found. Run '.kit/launchers/onboarding' first to configure your project" | 1 |
