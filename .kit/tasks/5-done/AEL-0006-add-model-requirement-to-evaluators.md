...
**Related**:
- [ADR-0004](../../docs/adr/ADR-0004-evaluator-definition-model-routing-separation.md) - Layered architecture
- [ADR-0005](../../docs/adr/ADR-0005-library-workflow-interface-contract.md) - Interface contract
...
- `docs/adr/ADR-0005-library-workflow-interface-contract.md` - Schema spec
