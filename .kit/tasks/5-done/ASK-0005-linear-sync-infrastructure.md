...
Add Linear task synchronization infrastructure to the starter kit. This enables projects using the kit to sync their markdown task files (`.kit/tasks/`) to Linear for visual project management.
...
1. **Task sync script** that reads `.kit/tasks/[1-7]-*/` folders and syncs to Linear
...
4. `.github/workflows/sync-to-linear.yml` - GitHub workflow
   ...
   - Triggers: Push to `.kit/tasks/[1-7]-*/`
   - Estimated lines: ~50
