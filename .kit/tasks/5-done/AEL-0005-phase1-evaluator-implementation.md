...
**Related**: [ADR-0002 Evaluator Expansion Strategy](../../docs/adr/ADR-0002-evaluator-expansion-strategy.md)
...
- `docs/adr/ADR-0002-evaluator-expansion-strategy.md` - Strategy and principles
