...
│  │     .kit/context/events/YYYY-MM-DD.jsonl               │
│  └────────────────────┬───────────────────┘                 │
│                       │                                      │
│          ┌───────────┼───────────┐                          │
│          ▼           ▼           ▼                          │
...
class WorkflowEventEmitter:
    ...
    def __init__(self, events_dir: str = ".kit/context/events"):
...
def read_events(
    ...
    task_id: Optional[str] = None,
    events_dir: str = ".kit/context/events"
) -> Iterator[dict]:
    """
...
def start_dashboard(events_dir: str = ".kit/context/events"):
...
def archive_old_events(days_to_keep: int = 30):
    ...
    events_dir = Path(".kit/context/events")
    archive_dir = Path(".kit/context/events/archive")
