...
2. **Raw review files create noise** - Storing full review markdown in `.kit/context/reviews/` preserves history but agents can't efficiently query or learn from dozens of verbose files.
...
```markdown
# .kit/context/REVIEW-INSIGHTS.md
...
```
Review the code review at `.kit/context/reviews/[TASK-ID]-review.md` and extract:
...
- `.kit/context/PROCEDURAL-KNOWLEDGE-INDEX.md`
